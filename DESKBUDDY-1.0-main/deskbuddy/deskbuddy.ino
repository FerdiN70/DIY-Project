...
void loadConfig() {
  ...
  if (wifiSsid.isEmpty()) {
    wifiSsid = "Modemku";
    wifiPass = "Ferdi1234";
    apiKey = "1ac94082f757788f790740e3ef2c76ef";
    city = "Jakarta";  // atau sesuaikan dengan kota kamu
    countryCode = "ID";
    tzString = "WIB-7";
  } else {
  ...
  if (tapCounter > 0) {
    if (now - lastTapTime > DOUBLE_TAP_DELAY) {
      ...
      if (tapCounter == 2) {
        ...
        display.ssd1306_command(highBrightness ? 0xFF : 0x01);
        display.display();
